function StartScreen(game){
	...
	this.instructions = $("<div/>")
		.css({backgroundColor: "yellow",zIndex:101,height:60,width:400,fontWeight: "bold",fontSize:'4em',margin:"auto",textAlign:"center",position:'relative',top:350,padding:5})
		.text("CONTROLS")
		.click(	function(){
