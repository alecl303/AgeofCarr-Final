function HumanTurret1(game,side) {
	...
	this.attack = function(){
		...
		var arr = new Arrow(loc,this.game,this.dmg,this.range,this.side);
	...
	this.respond = function(){
		setTimeout(function(){
			if(_this.inRange == true && _this.attacking ==false){
				_this.attackTimer = setInterval(function(){_this.attack();},200,'linear');
